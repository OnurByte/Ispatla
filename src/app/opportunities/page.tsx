...
export default function OpportunitiesRoute() {
  return <AppShell><main className="min-h-screen"><div className="mx-auto flex w-full max-w-[1180px] flex-col gap-7 px-4 py-6 sm:px-6 lg:px-8 lg:py-10"><PageHeading eyebrow="Market / keşif" title="Fırsatlar" description="Momentum ve tazelik eşiğini geçen kaynak postları burada listelenir; uygun kaynak kategorisi eşleşirse otomatik yayın adayı olur." /><MarketPage initial={getOpportunityItems()} accounts={getAccounts()} /></div></main></AppShell>;
}
